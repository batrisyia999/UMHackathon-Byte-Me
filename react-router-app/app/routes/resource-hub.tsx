        ...
        <div className="p-6 max-w-[1600px] mx-auto">
            <div className="flex items-center justify-between mb-6">
                ...
                <div className="relative">
                    ...
                    <input type="text" placeholder="Search resources..." className="pl-10 pr-4 py-2 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500" />
                </div>
            </div>

            <div className="flex gap-3 mb-6">
                {['All Resources', 'Guides', 'Templates', 'Videos', 'Webinars'].map((cat, i) => (
            ...
            <div className="grid grid-cols-3 gap-6">
                        ...
                        <div key={r.title} className="bg-white rounded-xl border border-gray-200 p-4 hover:shadow-lg transition-shadow flex items-start gap-4">
                            ...
                            <div className="flex-1">
                                ...
                                <div className="flex items-center gap-4 text-xs text-gray-600">
                                    ...
                                    <div className="flex items-center gap-1"><Download className="w-3.5 h-3.5" />{r.downloads.toLocaleString()}</div>
                                    <div>{r.duration}</div>
                                </div>
                            </div>
                            <button className="px-4 py-2 text-sm text-indigo-600 border border-indigo-200 rounded-lg hover:bg-indigo-50 flex items-center gap-2 flex-shrink-0">
                ...
                <div className="space-y-4">
                    <div className="bg-gradient-to-br from-indigo-50 to-purple-50 rounded-xl border border-indigo-100 p-5">
                        ...
                        <button className="w-full bg-indigo-600 text-white text-sm font-medium py-2 rounded-lg hover:bg-indigo-700">Ask AI Advisor</button>
                    </div>
                    <div className="bg-white rounded-xl border border-gray-200 p-5">
                        <h3 className="font-semibold mb-4">Upcoming Webinars</h3>
                        <div className="space-y-3">
                            {[{ title: 'Mastering Technical Interviews', date: '25 May 2025', time: '2:00 PM' }, { title: 'Scholarship Application Tips', date: '28 May 2025', time: '3:00 PM' }, { title: 'Building Your Personal Brand', date: '2 Jun 2025', time: '4:00 PM' }].map((w) => (
                                <div key={w.title} className="border-l-4 border-indigo-600 pl-3">
                                    ...
                                    <button className="mt-1 text-xs text-indigo-600">Register</button>
                                </div>
                            ))}
                        </div>
                    </div>
