...
export default function Readiness() {
    const modules = [
        { title: 'CV / Resume', description: 'Showcase your skills and experience', completion: 80, impact: 'High', suggestions: 'Add 2 quantified achievements to boost impact', action: 'Improve Now' },
        { title: 'Transcript', description: 'Academic performance & courses', completion: 100, impact: 'High', action: 'View' },
        { title: 'Portfolio', description: 'Projects that demonstrate your skills', completion: 40, impact: 'High', suggestions: 'Add 2 more projects with outcomes', action: 'Upload Project' },
        { title: 'LinkedIn', description: 'Professional presence & networking', completion: 60, impact: 'Medium', suggestions: 'Add a headline and 3 skills', action: 'Improve Now' },
        { title: 'Essay / Personal Statement', description: 'Your story, goals and motivation', completion: 30, impact: 'High', suggestions: 'Clarify your goals and motivation', action: 'Improve Now' },
        { title: 'Referee', description: 'Recommendations from mentors', completion: 25, impact: 'Medium', suggestions: 'Add at least 1 academic or professional referee', action: 'Add Referee' },
        { title: 'Certificates', description: 'Certifications & achievements', completion: 50, impact: 'Medium', suggestions: 'Add relevant certifications to stand out', action: 'Upload Certificate' },
        { title: 'Profile Completeness', description: 'Personal details & preferences', completion: 85, impact: 'High', suggestions: 'Add your location preference and career interests', action: 'Complete Now' },
    ];
            ...
            <div className="flex items-center justify-between mb-6">
                ...
                <div className="flex items-center gap-4">
                    <div className="text-right">
                        ...
                        <div className="text-3xl font-semibold text-green-600">72%</div>
            ...
            <div className="grid grid-cols-3 gap-6">
                <div className="col-span-2">
                                ...
                                return (
                                    <div key={mod.title} className="border border-gray-200 rounded-lg p-4">
                                        ...
                                        <div className="bg-gray-200 rounded-full h-1.5 overflow-hidden mb-3">
                                            <div className={`h-full rounded-full ${barColor}`} style={{ width: `${mod.completion}%` }}></div>
                                        </div>
                                        <div className="flex items-center justify-between">
                                            ...
                                            <button className="text-xs text-indigo-600 hover:text-indigo-700 font-medium">{mod.action}</button>
                                        </div>
                    ...
                    <div className="bg-indigo-50 rounded-xl border border-indigo-100 p-6">
                        ...
                        <button className="text-sm text-indigo-600 hover:text-indigo-700">See How →</button>
                    </div>
                </div>
                ...
                <div className="space-y-4">
                    <div className="bg-white rounded-xl border border-gray-200 p-5">
                        ...
                        <div className="space-y-3">
                            {[{ name: 'PETRONAS Digital Innovation Internship 2025', color: 'border-red-500', impact: '18%', bg: 'bg-teal-500' }, { name: 'Maybank Young Talent Programme', color: 'border-orange-500', impact: '14%', bg: 'bg-yellow-500' }, { name: 'Shell Graduate Programme 2025', color: 'border-orange-500', impact: '11%', bg: 'bg-orange-500' }].map((item) => (
                    ...
                    <div className="bg-white rounded-xl border border-gray-200 p-5">
                        ...
                        <div className="flex justify-between text-xs text-gray-600 mb-4"><span>72%</span><span>80%</span></div>
                        <button className="w-full bg-indigo-600 text-white text-sm font-medium py-2 rounded-lg hover:bg-indigo-700">View full plan</button>
                    </div>
                </div>
            </div>
        </div>
